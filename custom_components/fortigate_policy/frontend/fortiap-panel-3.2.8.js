...
class FortiApPresencePanel extends HTMLElement {
  ...
  _styles() {
    return `<style>
      :host{display:block;min-height:100vh;background:var(--primary-background-color);color:var(--primary-text-color);font-family:var(--paper-font-body1_-_font-family,system-ui,sans-serif);--panel-blue:#03a9f4;--panel-green:#2eaf68;--panel-purple:#9c6ade;--panel-orange:#f59e0b;--panel-surface:color-mix(in srgb,var(--primary-text-color) 7%,var(--primary-background-color));--panel-surface-strong:color-mix(in srgb,var(--primary-text-color) 11%,var(--primary-background-color));--panel-border:color-mix(in srgb,var(--primary-text-color) 14%,transparent)}
