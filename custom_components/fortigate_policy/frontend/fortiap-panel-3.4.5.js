  ...
  _styles() {
    return `<style>
      ...
      *{box-sizing:border-box}.mdi-icon{display:block;width:1em;height:1em;flex:0 0 auto;object-fit:contain}.shell{max-width:1500px;margin:0 auto;padding:24px 28px 110px}.top{position:relative;overflow:hidden;display:flex;align-items:center;justify-content:space-between;gap:24px;margin-bottom:18px;padding:22px 24px;background:var(--panel-surface);border:1px solid var(--panel-border);border-radius:18px;box-shadow:var(--ha-card-box-shadow,0 2px 8px rgba(0,0,0,.12))}.top:before{content:"";position:absolute;inset:0 auto 0 0;width:5px;background:var(--primary-color)}.brand{display:flex;align-items:center;gap:16px}.brand-mark{display:grid;place-items:center;width:52px;height:52px;border-radius:15px;background:color-mix(in srgb,var(--primary-color) 18%,var(--panel-surface));color:var(--primary-color)}.brand-mark .mdi-icon{width:30px;height:30px}.eyebrow{color:var(--primary-color);font-weight:750;font-size:12px;text-transform:uppercase;letter-spacing:.1em}h1{font-size:30px;line-height:1.15;margin:4px 0 7px}h2{font-size:20px;margin:0 0 5px}h3{font-size:16px;margin:0 0 4px}.muted{color:var(--secondary-text-color)}
      .tabs{display:grid;grid-template-columns:repeat(5,minmax(125px,1fr));gap:8px;margin-bottom:20px;padding:7px;background:var(--panel-surface);border:1px solid var(--panel-border);border-radius:14px;box-shadow:var(--ha-card-box-shadow,0 1px 3px rgba(0,0,0,.08));overflow:auto}.tab{display:flex;align-items:center;justify-content:center;gap:9px;border:1px solid transparent;background:transparent;color:var(--secondary-text-color);padding:11px 14px;font:inherit;font-weight:650;cursor:pointer;border-radius:9px;white-space:nowrap}.tab .mdi-icon{width:20px;height:20px}.tab:hover{background:var(--panel-surface-strong);color:var(--primary-text-color)}.tab.active{color:var(--primary-color);background:color-mix(in srgb,var(--primary-color) 14%,var(--panel-surface));border-color:color-mix(in srgb,var(--primary-color) 40%,var(--panel-border))}
      ...
      @media(max-width:900px){.shell{padding:18px 14px 110px}.span-3,.span-4,.span-6{grid-column:span 12}.form-grid{grid-template-columns:1fr 1fr}.top{display:block}.top .row{margin-top:16px}.tabs{grid-template-columns:repeat(5,minmax(125px,1fr))}table{display:block;overflow:auto}.savebar{padding:12px 14px}}
      @media(max-width:560px){
        ...
        .tabs{grid-template-columns:repeat(2,minmax(0,1fr));gap:5px;margin-bottom:10px;padding:5px;overflow:visible;border-radius:12px}.tab{min-width:0;min-height:42px;gap:6px;padding:8px 5px;font-size:12px;white-space:normal;line-height:1.15}.tab:last-child{grid-column:1/-1}.tab .mdi-icon{width:18px;height:18px}
