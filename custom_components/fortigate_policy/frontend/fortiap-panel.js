...
class FortiApPresencePanel extends HTMLElement {
  ...
  _icon(name) {
    return `<span class="mdi-icon" style="--mdi:url('${ICON_BASE}/${escapeHtml(name)}.svg')" aria-hidden="true"></span>`;
  }
