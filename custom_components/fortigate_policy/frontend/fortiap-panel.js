...
class FortiApPresencePanel extends HTMLElement {
  ...
  _icon(name) {
    ...
    return `<svg class="mdi-icon" viewBox="0 0 24 24" aria-hidden="true"><use href="${ICON_BASE}/${safeName}.svg#mdi-${safeName}"></use></svg>`;
  }
